...
#patches
cd device/qcom/common && curl -L -o mypatch.patch https://github.com/AOSPA/android_device_qcom_common/commit/832de59190dd996820281e78dd4afd55fe13dd9c.patch && patch -p1 < mypatch.patch && cd -
