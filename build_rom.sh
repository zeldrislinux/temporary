...
rclone copy out/target/product/liber/boot.img cirrus:liber/cr_16-8 -P 
rclone copy out/target/product/liber/dtbo.img cirrus:liber/cr_16-8 -P 
rclone copy out/target/product/liber/system.img cirrus:liber/cr_16-8 -P 
