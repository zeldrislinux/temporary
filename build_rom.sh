...
# upload SystemUI
rclone copy out/target/product/ginkgo/system_ext/priv-app/SystemUI/SystemUI.apk cirrus:$(grep unch $CIRRUS_WORKING_DIR/build_rom.sh -m 1 | cut -d ' ' -f 2 | cut -d _ -f 2 | cut -d - -f 1) -P
